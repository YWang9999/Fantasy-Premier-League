...
def main():
    ...
    gw_df_filtered = gw_df_team_features[TIME_RELATED_FEATURES + ['is_home', 'element_type', 'team_id', 'team_code']]

    features_df = gw_df_filtered[['element_type', 'is_home', 'team_id', 'team_code']]
